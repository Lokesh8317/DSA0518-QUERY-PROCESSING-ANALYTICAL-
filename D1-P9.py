...
data = {
    'OrderDate': [
        '1-6-18', '1-23-18', '2-9-18', '2-26-18', '3-15-18', '4-1-18',
    ...
    'Unit_price': [
        1198.00, 500.00, 1198.00, 225.00, 1198.00, 500.00, 1198.00,
        1198.00, 1198.00, 500.00, 1198.00, 500.00, 500.00, 1198.00,
        125.00, 58.50, 500.00, 225.00
    ],
    'Sale_amt': [
        113810.00, 25000.00, 43128.00, 6075.00, 67088.00, 30000.00,
        89850.00, 107820.00, 38336.00, 30000.00, 107820.00, 14500.00,
        40500.00, 41930.00, 250.00, 936.00, 14000.00, 14400.00
    ]
}
...
print("Pivot Table - Total Sale Amount (Region, Manager, Salesman Wise):")
print(pivot_table)
