...
data = {
    "JOB_ID": [
        "AD_PRES", "AD_VP", "AD_ASST", "FI_MGR", "FI_ACCOUNT", "AC_MGR", 
    ...
    "MIN_SALARY": [
        20080, 15000, 3000, 8200, 4200, 8200, 4200, 10000, 6000, 8000, 2500, 5500, 
        2008, 2500, 4000, 9000, 4000, 4000, 4500
    ],
    "MAX_SALARY": [
        40000, 30000, 6000, 16000, 9000, 16000, 9000, 20080, 12008, 15000, 5500, 8500, 
